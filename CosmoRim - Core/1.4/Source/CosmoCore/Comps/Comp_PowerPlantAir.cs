...
namespace CosmoCore
{
	...
	public class Comp_PowerPlantAir : CompPowerPlant
	{
		...
		public override void CompTick()
		{
			...
			{
				float num = Mathf.InverseLerp(CosmoCoreMod.settings.rainfallRange.min, CosmoCoreMod.settings.rainfallRange.max, parent.Map.TileInfo.rainfall);
				if (!CosmoCoreMod.settings.excludedBiomes[parent.Map.Biome.defName])
				{
